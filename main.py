...
icon = Image.open(r"C:\Users\ss\Downloads\IAMGE.jpg")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By ` LAVANYA`",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by `LAVANYA!`"""})
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background:url("https://images.unsplash.com/photo-1464618663641-bbdd760ae84a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8d2Vic2l0ZSUyMGJhY2tncm91bmR8ZW58MHx8MHx8fDA%3D&w=1000&q=80");
